...
public class SkillDisplay {
    ...
    public SkillDisplay(ItemStack icon, Identifier identifier, Text title, Text description, @Nullable Identifier background, AdvancementFrame frame, boolean showToast, boolean announceToChat, boolean hidden) {
        this.title = title;
    ...
    public static SkillDisplay fromPacket(PacketByteBuf buf) {
        ...
        boolean bl = (i & 2) != 0;
        boolean bl2 = (i & 4) != 0;
        SkillDisplay advancementDisplay = new SkillDisplay(itemStack, identifier, text, text2, identifier, advancementFrame, bl, false, bl2);
